...
VARS_IMMEDIATE = [
    ...
    rn.GRID_C_VOLTAGE, rn.ACTIVE_GRID_C_CURRENT, rn.POWER_METER_REACTIVE_POWER,
    rn.FREQUENCY,rn.INVERTER_OPERATION_MODE,
]
VARS_PERIODIC = [
    ...
    rn.POWER_METER_REACTIVE_ENERGY, rn.POWER_METER_APPARENT_ENERGY,rn.POWER_METER_APPARENT_POWER,
    ]
